...
public class CustomerDashboard extends JFrame {
        ...
        public CustomerDashboard(Customer customer, Cinema cinema) {
                ...
                JLabel welcomeMessage = new JLabel("Select an option from the menu", SwingConstants.CENTER);
        ...
        private void showMovies() {
                ...
                if (cinema.getMovies().isEmpty()) {
                        ...
                        moviePanel.add(new JLabel("No movies available."));

                } else {

                        for (Movie movie : cinema.getMovies()) {

                                JPanel movieCard = new JPanel(new GridLayout(4, 1));

                                movieCard.setBorder(BorderFactory.createTitledBorder(movie.getMovieName()));

                                movieCard.add(new JLabel("Movie ID: " + movie.getMovieId()));

                                movieCard.add(new JLabel("Genre: " + movie.getGenre()));

                                movieCard.add(new JLabel("Duration: " + movie.getDuration() + " hours"));
        ...
        private void showShows() {
                ...
                JLabel title = new JLabel("AVAILABLE SHOWS", SwingConstants.CENTER);
                ...
                if (cinema.getShows().isEmpty()) {
                        ...
                        showPanel.add(new JLabel("No shows available."));

                } else {

                        for (Show show : cinema.getShows()) {

                                JPanel showCard = new JPanel(new GridLayout(5, 1));

                                showCard.setBorder(BorderFactory.createTitledBorder(show.getMovie().getMovieName()));

                                showCard.add(new JLabel("Show ID: " + show.getShowId()));

                                showCard.add(new JLabel("Date: " + show.getDate()));

                                showCard.add(new JLabel("Time: " + show.getTime()));

                                showCard.add(new JLabel("Available Seats: " + getAvailableSeats(show)));

                                JButton bookButton = new JButton("Book This Show");
        ...
        private void showSeatSelection(Show show) {
                ...
                JLabel title = new JLabel("SELECT YOUR SEAT - " + show.getMovie().getMovieName(),
                ...
                for (Seat seat : show.getSeats()) {
                        ...
                        JRadioButton seatButton = new JRadioButton(seat.getSeatNumber());

                        seatButton.setHorizontalAlignment(SwingConstants.CENTER);

                        seatButton.setActionCommand(seat.getSeatNumber());
                ...
                JButton backButton = new JButton("Back to Shows");
                ...
                confirmButton.addActionListener(e -> {
                        ...
                        ButtonModel selectedModel = seatGroup.getSelection();
                        ...
                        String selectedSeatNumber = selectedModel.getActionCommand();
                        ...
                        if (selectedSeat == null) {
                                ...
                                JOptionPane.showMessageDialog(this, "Seat could not be found.");
                        ...
                        // Create ticket
                        Ticket ticket = new Ticket(nextTicketId++, customer, show, selectedSeat, 500.0);
        ...
        private void showMyTickets() {
                ...
                for (Ticket ticket : cinema.getTickets()) {
                        ...
                        if (ticket.getCustomer().getUserId() == customer.getUserId()) {
                                ...
                                JPanel ticketCard = new JPanel(new GridLayout(7, 1));

                                ticketCard.setBorder(
                                                BorderFactory.createTitledBorder("Ticket #" + ticket.getTicketId()));

                                ticketCard.add(new JLabel("Movie: " + ticket.getShow().getMovie().getMovieName()));

                                ticketCard.add(new JLabel("Date: " + ticket.getShow().getDate()));

                                ticketCard.add(new JLabel("Time: " + ticket.getShow().getTime()));

                                ticketCard.add(new JLabel("Seat: " + ticket.getSeat().getSeatNumber()));

                                ticketCard.add(new JLabel("Price: " + ticket.getPrice()));
                                ...
                                cancelButton.addActionListener(e -> {
                                        ...
                                        int choice = JOptionPane.showConfirmDialog(this,
                                                        "Cancel Ticket #" + ticket.getTicketId() + "?", "Cancel Ticket",
                ...
                if (!found) {
                        ...
                        ticketPanel.add(new JLabel("You have no tickets."));
                }
